        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <nav className="hidden lg:flex items-center space-x-6">
              ...
              <Link href="/contacto" className="text-blue-400 font-medium px-3 py-2 rounded-md bg-gray-800">
                Contacto
              </Link>
            ...
            <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-6 mt-20">
              ...
              <div className="bg-gray-900/50 rounded-2xl p-10 border border-gray-700/50 hover:border-blue-500/30 transition-colors min-h-[220px] flex flex-col">
                ...
                <div className="mt-auto">
                  <Link href="mailto:ana.trabajeconnosotros.2024@gmail.com" className="text-blue-400 hover:text-blue-300 transition-colors text-sm block whitespace-nowrap overflow-hidden text-ellipsis">
              ...
              <div className="bg-gray-900/50 rounded-2xl p-10 border border-gray-700/50 hover:border-green-500/30 transition-colors min-h-[220px] flex flex-col">
                ...
                <div className="mt-auto">
                  <Link href="tel:+573142876981" className="text-green-400 hover:text-green-300 transition-colors text-lg font-medium">
                    314 287 6981
                  </Link>
                </div>
              </div>
